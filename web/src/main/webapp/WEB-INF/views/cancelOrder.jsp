...
<div><a href="/">Home </a><a href="/account/orders">/ orders </a>/ order</div>
<nav1>
...
<box class="w3-container ">
    <div class="w3-card-4 w3-round-large w3-padding" style="width: 70%"><br>
        ...
        <h3>You order No. ${rental.id} was REFUSED!</h3>
        <table style="font-size: 12px">
            ...
            <tr>
                ...
                <td style="font-size: 12px"><span style="color: crimson" aria-flowto="">${rental.carDto.price}</span>
                </td>
