        ...
        <flex>
            ...
            <table style="font-size: 10px">
                <tr>
                    ...
                    <tr>
                        <td>${rental.id}</td>
                        <td><a href="${pageContext.request.contextPath}/admin/cars/car/${rental.carDto.id}" class="w3-text-white">
                            ID${rental.carDto.id}, ${rental.carDto.brand} ${rental.carDto.model}, No. ${rental.carDto.number}</a></td>
                        <td><a href="${pageContext.request.contextPath}/admin/users/user/${rental.userDto.id}" class="w3-text-white">
                        ...
                        <td><a style="color: yellow" href="${pageContext.request.contextPath}/admin/rentals/rental/${rental.id}"
                               class="w3-text-blue">EDIT</a></td>
<%--                        --%>
<%--                        <td><a style="color: red" href="${pageContext.request.contextPath}/admin/rentals/rental/${rental.id}"--%>
<%--                               class="w3-text-blue">REFUSED</a></td>--%>

<%--                        <td><a style="color: greenyellow" href="${pageContext.request.contextPath}/admin/rentals/rental/${rental.id}"--%>
<%--                               class="w3-text-blue">APPROVE</a></td>--%>
                    </tr>
            </table>
            </br>
        </flex>
