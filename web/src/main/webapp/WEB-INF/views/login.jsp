...
<box>
    <form method="post" action="/login_post" class="w3-card-4 w3-blue-grey w3-round-large w3-padding" style="width: 20%">
        <flex>
            ...
            <p style="font-size: 12px">Enter for admin or manager <a
                    href="${pageContext.request.contextPath}/admin/login">login</a></p>
        </flex>
    </form>
</box>
</body>
